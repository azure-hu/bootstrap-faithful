# bootstrap-faithful
Custom made Bootstrap theme based on Bootstrap v2.3.2, BootSwatch v2.3.2 Cerulean and Spacelab themes, FontAwesome v3.2.1 font, and some extra addons, like colors backported from MDBoostrap 4 (https://github.com/mdbootstrap/bootstrap-material-design)
